...
assert 'override_privacy_exporter' in compat and 'secure_forward_message' in compat
print('Private communication invariants: PASS')
PY

echo '== Exact staged source manifest and reproducible package =='
BASE='17-sabri-network-and-messages-2.0.3'; rm -rf build; bash tools/package.sh >/tmp/file17-package-first.log
