...
js_files=(assets/js/network.js assets/js/meet.js assets/js/messages.js assets/js/message-search.js assets/js/smail.js assets/js/file-transfer.js assets/js/two-plan-ui.js)
...
paths=('assets/css/network.css','assets/css/meet.css','assets/css/messages.css','assets/css/message-search.css','assets/css/smail.css','assets/css/file-transfer.css','assets/css/brand-green-overrides.css','assets/css/two-plan-ui.css')
for path in paths:
 text=Path(path).read_text(encoding='utf-8'); assert text.count('{')==text.count('}'),f'{path}: unbalanced braces'
for path in ('assets/css/meet.css','assets/css/messages.css','assets/css/message-search.css','assets/css/smail.css','assets/css/file-transfer.css','assets/css/two-plan-ui.css'):
 text=Path(path).read_text(encoding='utf-8'); assert 'prefers-reduced-motion' in text; assert '44px' in text
for path in ('assets/css/smail.css','assets/css/file-transfer.css','assets/css/two-plan-ui.css'):
 text=Path(path).read_text(encoding='utf-8'); assert ('#137a46' in text or '#087a4e' in text); assert ('max-width:' in text or 'width:min(' in text)
...
for marker in ('sn_idempotency_key_required','response_cipher','discoverable_private'):
...
print('Private communication and two-plan UI invariants: PASS')
PY
