...
required=(sabri-network.php readme.txt CHANGELOG.md SECURITY.md CF01-COMMUNICATION-CONTEXT-CONTRACT.md includes/class-sn-db.php includes/class-sn-auth.php includes/class-sn-messages.php includes/class-sn-outbox.php includes/class-sn-privacy.php includes/class-sn-cf01-clinical-context.php includes/class-sn-communication-crypto.php includes/class-sn-message-body.php includes/class-sn-central-plan-hardening.php includes/class-sn-compatibility-hardening.php includes/class-sn-two-plan-completion.php includes/class-sn-two-plan-contract-firewall.php includes/class-sn-two-plan-presentation.php includes/class-sn-two-plan-runtime-hardening.php includes/class-sn-future-superset.php includes/class-sn-future-superset-part-1.php includes/class-sn-future-superset-part-2.php includes/class-sn-future-superset-part-3.php includes/class-sn-future-superset-core.php includes/class-sn-membership-assertions.php includes/class-sn-relationship-runtime-hardening.php includes/class-sn-message-runtime-hardening.php includes/class-sn-attachment-runtime-hardening.php includes/class-sn-space-runtime-hardening.php includes/class-sn-realtime-runtime-hardening.php includes/class-sn-call-runtime-hardening.php includes/class-sn-smail-runtime-hardening.php includes/class-sn-privacy-runtime-hardening.php includes/class-sn-safety-runtime-hardening.php templates/network-standalone.php templates/messages-standalone.php templates/meet-app.php templates/smail-app.php templates/file-transfer-app.php assets/js/smail.js assets/js/file-transfer.js assets/js/two-plan-ui.js assets/js/future-superset.js assets/css/smail.css assets/css/file-transfer.css assets/css/two-plan-ui.css assets/css/future-superset.css tools/quality-check.sh tools/package.sh)
