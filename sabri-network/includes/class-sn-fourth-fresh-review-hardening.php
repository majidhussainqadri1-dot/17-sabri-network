...
final class SN_Fourth_Fresh_Review_Hardening {
    ...
    public static function override_routes(): void {
        ...
        register_rest_route('sabri-network/v2', '/messages/(?P<id>\d+)/reaction', [
    ...
    /** Serialize reaction changes with message deletion/membership and fail closed on positive eligibility changes. */
