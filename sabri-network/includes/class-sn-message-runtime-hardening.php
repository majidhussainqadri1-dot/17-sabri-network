...
final class SN_Message_Runtime_Hardening {
    ...
    public static function send_message(WP_REST_Request $request):WP_REST_Response|WP_Error{
        ...
        try{
            // Revalidate canonical posting authority after mutation locks are held.
        ...
        // Notification facts are emitted only after the canonical transaction exists.
    ...
    private static function contact_check(object $conversation,int $conversation_id,int $actor):bool|WP_Error{
