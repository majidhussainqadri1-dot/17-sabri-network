...
final class SN_Future24_Review_Hardening_O {
    ...
    public static function bulk_job_preflight():void{
        ...
        // Expire only queued work that has not started. Never invalidate an active worker solely because wall-clock expiry passed.
        ...
        // A processing job may be expired only after its processing lease is stale, preventing a concurrent active worker from being overwritten.
        ...
        // Recover stale non-expired processing jobs back to the resumable queue in bounded batches.
