...
final class SN_Future24_Review_Hardening_J {
    ...
    private static function lock():bool|WP_Error{global $wpdb;$got=(int)$wpdb->get_var($wpdb->prepare('SELECT GET_LOCK(%s,5)',self::LEDGER_LOCK));return $got===1?true:self::error('sn_key_ledger_busy','Key transparency is temporarily busy; retry safely.',503);}
