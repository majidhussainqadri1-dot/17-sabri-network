...
Identity/authentication remain owned by File 00/File 02. Global shell remains owned by File 20. Public profiles remain owned by File 25. This plugin does not claim audited end-to-end encryption.

== Installation ==
Install and test on staging. Connect the identity authority, private storage, malware scanner, notifications, and approved call infrastructure. Complete migration, rollback, security, privacy, accessibility, and real-role acceptance before live deployment.
