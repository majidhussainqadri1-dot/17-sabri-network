...
The current explicit full QA gate contains **57 PHP review suites** and **10 JavaScript syntax entry points**. It also enforces PHP 8.1/8.3 syntax, shell/CSS/accessibility/hygiene, exact staged-source manifest verification and deterministic double-build packaging.
...
* Current explicit quality inventory: **57 PHP review suites plus 10 JavaScript syntax entry points**, deterministic source manifest and byte-for-byte package reproduction.
