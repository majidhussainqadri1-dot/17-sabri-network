...
ftc(str_contains($main,'class-sn-file-transfer.php')&&str_contains($main,'SN_File_Transfer::register()')&&str_contains($migration,"[SN_File_Transfer::class,'install']")&&!str_contains($main,'SN_File_Transfer::install()'),'File-transfer lifecycle is loaded/registered while schema install is owned only by serialized migration governance.');
