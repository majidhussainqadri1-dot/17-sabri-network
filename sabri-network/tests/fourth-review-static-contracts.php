...
fr4_check(str_contains($status, 'Coding Completion: 100% code-complete candidate') && str_contains($readme, 'four-plan/forty-round code-complete corrective candidate') && str_contains($readme, '**Staging-Accepted:** pending'), 'Installable documentation must preserve the code-complete/staging-pending boundary.');
