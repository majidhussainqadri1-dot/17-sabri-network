...
fr4_check(str_contains($completeness, '**Coding classification:** **repository coding-completion candidate; exact-head QA and fresh corrective review required before merge**') && str_contains($completeness, '**Staging-Accepted:** pending'), 'Repository evidence must state current coding-candidate status without claiming staging/operational completion.');
