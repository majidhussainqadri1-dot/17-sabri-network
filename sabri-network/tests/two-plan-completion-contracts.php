...
$check(str_contains($system_status,'56 PHP review suites')&&str_contains($system_status,'10 JavaScript entry-point syntax checks'),'Current system-status QA inventory must match the executable quality gate.');
