...
r18(str_contains($relationship,'$rels=file_get_contents')&&str_contains($relationship,'str_contains($rels')&&str_contains($relationship,'$wpdb->last_error'),'Relationship regression must compare a literal $wpdb source needle without PHP interpolation.');
