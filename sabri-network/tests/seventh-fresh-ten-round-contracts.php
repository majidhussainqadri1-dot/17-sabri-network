...
$check(str_contains($futureH,"new WP_Error('sn_interop_idempotency_conflict'")||str_contains($futureH,"self::error('sn_interop_idempotency_conflict'") ,'Fresh R8: mismatched interoperability bridge reuse must fail with an explicit idempotency conflict.');
