...
check(str_contains($main, 'Version: 2.0.0'), 'Plugin header must declare version 2.0.0.');
check(str_contains($main, "define('SN_VERSION', '2.0.0')"), 'SN_VERSION must be 2.0.0.');
