...
$check(str_contains($status,'Code-complete candidate')&&str_contains($status,'not staging-accepted'),'System status must distinguish coding from staging acceptance.');
$check(str_contains($readme,'100% coded candidate')&&str_contains($readme,'not production-operational'),'README must state the truthful completion boundary.');
