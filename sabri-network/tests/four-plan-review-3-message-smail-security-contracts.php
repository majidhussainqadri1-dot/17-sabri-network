...
$root=dirname(__DIR__);$main=file_get_contents($root.'/sabri-network.php');$body=file_get_contents($root.'/includes/class-sn-message-body.php');$integrity=file_get_contents($root.'/includes/class-sn-message-integrity.php');$search=file_get_contents($root.'/includes/class-sn-message-search.php');$smail=file_get_contents($root.'/includes/class-sn-smail-part-2.php');$hard=file_get_contents($root.'/includes/class-sn-central-plan-hardening.php');$compat=file_get_contents($root.'/includes/class-sn-compatibility-hardening.php');$fails=[];$checks=0;
