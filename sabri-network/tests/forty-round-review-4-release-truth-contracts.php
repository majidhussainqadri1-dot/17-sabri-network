...
$check(str_contains($status,'review suites')&&str_contains($status,'**54**')&&str_contains($complete,'review suites')&&str_contains($complete,'**54**'),'Current repository status and coding assessment must publish the current 54-suite gate.');
...
$check(
    ...
    str_contains($complete,'R1, R2, R3, R4, R6, R7, R8, R9, R10')&&str_contains($complete,'R5')&&
