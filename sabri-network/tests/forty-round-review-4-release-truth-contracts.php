...
$check(str_contains($status,'review suites')&&str_contains($status,'**60**')&&str_contains($complete,'review suites')&&str_contains($complete,'**60**'),'Current repository status and coding assessment must publish the current 60-suite gate.');
