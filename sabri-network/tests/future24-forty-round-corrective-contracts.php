...
$checks = [
    ...
    'includes/class-sn-future24-review-hardening-g.php' => ['telemetry_consent', 'explicit_consent', 'semantic-search/consent', 'exported_to_file26'=>false],
...
foreach ($checks as $file => $needles) {
    $source = $read($file);
    foreach ($needles as $needle) $assert(str_contains($source, (string) $needle), "{$file} missing regression marker: {$needle}");
}
