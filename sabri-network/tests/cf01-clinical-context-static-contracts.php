...
sn_cf01_static_assert(str_contains($main, 'Version: 2.0.3'), 'plugin header is File 17 2.0.3');
sn_cf01_static_assert(str_contains($main, "define('SN_VERSION', '2.0.3')"), 'runtime version is File 17 2.0.3');
...
sn_cf01_static_assert(str_contains($readme, 'Stable tag: 2.0.3'), 'readme stable tag is File 17 2.0.3');
